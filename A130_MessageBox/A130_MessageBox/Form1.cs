...
namespace A130_MessageBox
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("느낌표와 알람 메시지박스", "느낌표와 알림소리", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);

            DialogResult result1 = MessageBox.Show("두개의 버튼을 갖는 메시지 박스입니다", "Question", MessageBoxButtons.YesNo);
